  <nav class="navbar navbar-inverse navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Swift Rentals</a>
        </div>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="SalesPerYear.php">Per Year</a></li>
                  <li><a href="SalesPerQuarter.php">Per Quarter</a></li>
                  <li><a href="SalesPerMonth.php">Per Month</a></li>
                </ul>
            </li>          
            <li class="dropdown">
